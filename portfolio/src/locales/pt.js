export const pt = {
  bio: {
    ...
    p1: 'Em 2018, tive meu primeiro contato com programação no ensino médio, onde aprendi a linguagem Pascal. Após uma pausa, retomei a programação em C na faculdade, atualmente cursando Sistemas de Informação.',
    p2: 'Durante esse período, desenvolvi interesse em desenvolvimento web, estudando HTML, CSS e JavaScript de forma independente. Atualmente, foco meus estudos no desenvolvimento back-end e trabalho principalmente com integração de dados, especialmente entre bancos de dados e APIs, utilizando SQL.',
    p3: 'Neste site, você encontrará informações sobre mim, meu currículo e meu blog, onde pretendo compartilhar meus conhecimentos e experiências. Além disso, você pode conferir alguns dos meus projetos logo abaixo.',
  },
  projects: {
    title: 'projetos',
  },
